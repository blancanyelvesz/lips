"""
This script calculates the perplexity of text files using the pre-trained language model Falcon-7b available in huggingface 🤗 for contexts of sizes 10, 20, 30, 40, and 50.
...
args = docopt(__doc__, version = '1.2 - Falcon-7b')
method = args['--method']
